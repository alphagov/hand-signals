<template>
  <div @mouseenter.self="mouseIn" @mouseleave.self="mouseOut" @click="removeRespond(messageId)" class="nod-message">
    <div class="nod-emoji-wrapper">
      <img v-if="hover" :src="getCloseButton" alt="Remove icon" class="nod-emoji" />
      <img v-else :src="getRespond" alt="I want to respond" class="nod-emoji" />
    </div>
...
export default {
  ...
  methods: {
    ...
    removeRespond(key) {
      ...
      this.$store.dispatch("removeRespond", key);
